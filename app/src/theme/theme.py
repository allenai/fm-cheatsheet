...
def add_header():
    st.write(f'<div class="header" role="heading"><a href="https://allenai.org"> <img src="https://cdn.jsdelivr.net/npm/@allenai/varnish@3.0.7/shellac/ai2.svg" alt="Allen Institute for AI"> </a></div>', unsafe_allow_html=True)
